...
const Navbar = () => {
  ...
  return (
    <>
      {/* Top bar */}
      <div className="flex justify-between py-3 px-1.5 md:bg-gray-200 md:rounded-4xl md:px-6 max-w-7xl mx-auto" >
        <div className="flex gap-2 mt-1">
          ...
          <p className="font-bold text-primary text-2xl font-secondary">CleanLife</p>
        </div>

        <div className="items-center gap-8 font-semibold text-primary hidden md:flex">
          <a href="#">Palvelumme</a>
          <a href="#">Hinnasto</a>
        </div>
      ...
      >
        ...
        <nav className="flex flex-col gap-4 py-5 px-2.5">
          <a
            href="#palvelumme"
            className="text-lg font-semibold text-text hover:light_gray transition-colors"
            onClick={closeSidebar}
          >
            Palvelumme
          </a>
