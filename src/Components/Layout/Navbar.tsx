    ...
    <>
      ...
      <div className="flex justify-between py-3 px-1.5 md:bg-gray-200 md:rounded-4xl md:px-6 max-w-7xl mx-auto" >
        <div className="flex gap-2  items-center">
          ...
          <p className="font-bold text-primary text-xl font-secondary">CleanLife</p>
        </div>

        <div className="gap-8 items-center md:flex hidden">
          <div className="items-center font-semibold text-primary    hover:text-light_gray transition-colors">
            <a href="#">Palvelumme</a>
            </div>
            <div className="items-center font-semibold text-primary   hover:text-light_gray transition-colors">
            <a href="#">Hinnasto</a>
